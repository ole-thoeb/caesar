...
**Build Tools:** Caesar builds [Z3](https://github.com/Z3Prover/z3) itself, so we need [Python](https://www.python.org)
and [CMake](https://cmake.org/) together with a C++ compiler supporting C++17. After installation, ensure that CMake uses a suitable compiler TODO: How?.
